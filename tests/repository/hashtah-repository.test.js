...
test("Testing that tweet creation is working fine or not",async ()=>{
     ...
     const mockHashTagCreation=jest.spyOn(Hashtag, 'create').mockImplementation(()=>{
        return data;
     })
...
test("Testing for Hashtag are getting successfukky or not", async ()=>{
    ...
    const mockHastagRead=jest.spyOn(Hashtag, 'findOne').mockImplementation(()=>{
        return data;
    })
...
test("Testing for Hashtag deleting successfully", async ()=>{
    ...
    const mockHastagDelete=jest.spyOn(Hashtag, 'findByIdAndDelete').mockImplementation(()=>{
        return true;
    })
